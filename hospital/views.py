...
#for showing signup/login button for admin(by Ankit Acharya)
...
#for showing signup/login button for doctor(by Ankit Acharya)
...
#for showing signup/login button for patient(by Ankit Acharya)
...
#-----------for checking user is doctor , patient or admin(by Ankit Acharya)
def is_admin(user):
